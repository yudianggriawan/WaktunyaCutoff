...
WebUI.click(findTestObject('Page_Swag Labs/button_Menu'))  // Click on menu button
WebUI.click(findTestObject('Page_Swag Labs/button_Logout')) // Click on logout button

// Verify that the login page is displayed again
WebUI.verifyElementVisible(findTestObject('Page_Swag Labs/input_Username')) // Check if the username field is visible
